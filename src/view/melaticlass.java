...
import kontrolimplementasi.temankelass;
 ...
 * @author microsoft
 */
public class melaticlass extends javax.swing.JFrame {
    List <model> record = new ArrayList<>();
    Interface melatiservice;
    int row;

    /**
     * Creates new form melaticlass
     */
    public melaticlass() {
        initComponents();
        melatiservice = new temankelass();
        this.refresdata();
...
isitabel();
    ...
    private void jBTN_HAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTN_HAPUSActionPerformed
        ...
        // if(id.trim().equals("") && nama.trim().equals("")){
            ...
            //}else{
            try {
                melatiservice.hapus(jTBL_Teman.getValueAt(row, 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(melaticlass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new melaticlass().setVisible(true);
            }
        });
    }
